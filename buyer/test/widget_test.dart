...
// (MyApp now requires an AppConfig and the app wires up GetIt/Firebase at
// startup, which a naive widget pump can't satisfy). This test verifies the
// flavor configuration the app boots with instead.
